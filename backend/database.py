...
# zwlaszcza po dluzszej przerwie bez ruchu (np. wieczorem) - dokladnie ten sam bug
# naprawiony w appce Waga tego samego dnia. pool_pre_ping robi tanie "SELECT 1"
# przed kazdym uzyciem polaczenia z puli i po cichu je odtwarza, jesli jest martwe;
# pool_recycle dodatkowo wymusza odswiezenie polaczen starszych niz 5 min, zanim
# Neon zdazy je samo zamknac.
